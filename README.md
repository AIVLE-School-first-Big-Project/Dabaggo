...
>'Dabaggo'는 외국인과 소통을 위한 웹 동시 통역기 서비스입니다. <br>  https://carot-4cbc3.web.app/ 해당 URL 통해 접속가능(서버 구동시) <br> *자체번역 모델 사용시 크롬-> 사이트 설정-> 안전하지않은 컨텐츠를 허용으로 변경해주세요!(처음에 2~3초 정도 번역시간 걸립니다)
