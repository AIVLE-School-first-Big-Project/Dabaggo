...
if __name__ == '__main__':
    ...
    TRG=joblib.load('model/TRG.pkl')
    model = torch.load('model/transformer_model(cpu).pt',map_location=device)
    model.load_state_dict(torch.load('model/transformer_korean_to_english (5).pt',map_location=device))
